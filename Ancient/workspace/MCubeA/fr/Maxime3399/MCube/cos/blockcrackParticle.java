      ...
      Bukkit.getScheduler().scheduleSyncRepeatingTask(Bukkit.getPluginManager().getPlugin("M-Cube"), new Runnable(){
        ...
        public void run(){
          ...
          for (Player pls : Bukkit.getOnlinePlayers()){
            ...
            if ((MCubeAPI.getActiveCos(pls).contains("blockcrack")) && (!PlayerDeath.al.contains(pls))){
              ...
              Bukkit.getWorld(pls.getLocation().getWorld().getName()).spawnParticle(org.bukkit.Particle.BLOCK_CRACK, loc, 0, 0, 0, 0, 1);
